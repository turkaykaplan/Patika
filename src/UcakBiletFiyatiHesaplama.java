...
public class deneme {
    ...
    public static void main(String[] args) {
        ...
        total = distance * 0.10;                // Toplam bilet fiyatı üzerinden:
        discount1 = total - (total * 0.5);    // 12 yaşından küçükler için %50 indirim
        discount2 = total - (total * 0.1);    // 12-24 yaş arası için %10 indirim
        discount3 = total - (total * 0.3);    // 65 yaş üstü için %30 indirim
        discount4 = total - (total * 0.2);    // Gidiş-dönüş bileti (Tip=2) için  %20 indirim
        discount5 = discount1 - (discount1 * 0.2); // Gidiş dönüş indirimi & 12 yaşından küçükler için %50 indirim
        discount6 = discount2 - (discount2 * 0.2); // Gidiş dönüş indirimi & 12-24 yaş arası için %10 indirim
        discount7 = discount3 - (discount3 * 0.2); // Gidiş dönüş indirimi & 65 yaş üstü için %30 indirim
